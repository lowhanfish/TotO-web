    ...
    return (
        <div className="mt-10 px-2 md:px-8">
            ...
            <div className="flex flex-col md:flex-row md:gap-10">
                <div className="flex-1 p-2 mb-10 lg:p-10 bg-ltwo-2/20 text-center border-8 border-lfirst-3 rounded-[24]">
                ...
                <div className="flex-1 p-2 mb-10 lg:p-10 bg-[#87A1A0]/75 text-center border-8 border-lfirst-5 rounded-[24]">
